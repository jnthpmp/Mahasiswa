...
public class MahasiswaFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button gantiUpdate = view.findViewById(R.id.btnUpdate);
        Button gantiDelete = view.findViewById(R.id.btnDelete);
        Button gantiNew = view.findViewById(R.id.btnNew);

        gantiNew.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        gantiDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                k.tampil();
            }
        ...
        gantiUpdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
